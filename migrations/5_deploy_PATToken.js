...
module.exports = function(deployer, network) {
  ...
  deployer.then (() => {
      ...
      return deployer.deploy(PATToken, registered_user.address, id, manager_addr, name, symbol, fixedDocsLink, fixedDocsHash, varDocsLink, varDocsHash, {from : owner, overwrite: overwrite});
  }).then(() => {
